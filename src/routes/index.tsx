    ...
    <div className="min-h-screen bg-dark text-white font-sans">
      <header className="fixed top-0 inset-x-0 z-50 border-b border-white/10 bg-dark/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 md:px-6">
          ...
          <nav className="hidden md:flex items-center gap-7 text-sm font-medium text-white/70">
            ...
            <a href="#coaches" className="hover:text-brand transition-colors">
              Coaches
            </a>
      ...
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 md:px-6 text-center">
          <p className="font-mono text-[11px] uppercase tracking-[0.35em] text-brand mb-6">
            {SITE.rating}★ · {SITE.reviewCount}+ Google reviews · Unisex
          </p>
          <h1 className="font-display text-5xl sm:text-7xl md:text-8xl lg:text-9xl uppercase leading-[0.9] tracking-tight">
            Chromepet's
            <br />
          ...
          <p className="mt-8 max-w-xl mx-auto text-white/60 text-lg leading-relaxed">
      ...
      <section className="py-8 md:py-12 border-y border-white/10 bg-black/40">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <ArchGallery items={galleryItems} cardWidth={170} cardHeight={240} cornerRadius={16} className="py-4" />
        </div>
      </section>
            ...
            {[
              {
                n: "01",
                t: "Strength",
                d: "Full free-weight floor, racks, platforms and cable stacks. Progressive overload with form checks so you build muscle safely.",
                items: ["Barbells · Racks · Platforms", "Form coaching", "Progressive overload"],
              },
              {
                n: "02",
                t: "Cardio + HIIT",
                d: "High-intensity sessions and cardio zones designed for fat loss and conditioning. Small groups, clear heart-rate targets.",
                items: ["Treadmills · Bikes · Rowers", "Class size limited", "Heart-rate zones"],
              },
              {
                n: "03",
                t: "Personal Training",
                d: "Custom plans, nutrition guidance and weekly check-ins. One-on-one accountability that gets real results.",
                items: ["Bespoke programming", "Nutrition support", "Weekly check-ins"],
              },
            ].map((p) => (
        ...
        <div className="mx-auto max-w-6xl px-4 md:px-6 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-6 text-white/60 leading-relaxed">
              ...
              coach, and a community that shows up early. Open long hours so you can train around your life.
            </p>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: "The floor is open to everyone all day. Our head coach also runs dedicated women’s strength blocks in the morning and evening. Being women-owned, comfort and safety come first.",
              },
              {
