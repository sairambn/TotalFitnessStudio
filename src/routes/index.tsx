    ...
    <div className="min-h-screen bg-dark text-white font-sans">
      ...
      <header className="fixed top-0 inset-x-0 z-50 border-b border-white/10 bg-dark/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 md:px-6">
          ...
          <nav className="hidden md:flex items-center gap-7 text-sm font-medium text-white/70">
            <a href="#programs" className="hover:text-brand transition-colors">
              Programs
            </a>
            <a href="#results" className="hover:text-brand transition-colors">
              Results
            </a>
      ...
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 md:px-6 text-center">
          ...
          <p className="mt-8 max-w-xl mx-auto text-white/60 text-lg leading-relaxed animate-fade-up delay-200">
            Real coaches. Real equipment. Real results. Open {SITE.hours.label}. Located above Axis
            Bank, Hasthinapuram.
          </p>
      ...
      <section id="programs" className="py-24 md:py-32 border-t border-white/10">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          ...
          <p className="max-w-2xl text-white/60 text-lg mb-14">
            From your first session to competition prep — clear programs, proper form coaching, and
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-7 card-lift">
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-5">
                Full free-weight floor, racks, platforms and cable stacks. Progressive overload with
                form checks so you build muscle safely.
              </p>
              <ul className="space-y-2 text-sm text-white/80">
                <li className="flex items-center gap-2">
                  <span className="h-1 w-1 rounded-full bg-brand" />
                  Barbells · Racks · Platforms
                </li>
                <li className="flex items-center gap-2">
                  <span className="h-1 w-1 rounded-full bg-brand" />
                  Form coaching
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-7 card-lift">
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-5">
                High-intensity sessions and cardio zones designed for fat loss and conditioning.
                Small groups, clear heart-rate targets.
              </p>
              <ul className="space-y-2 text-sm text-white/80">
                <li className="flex items-center gap-2">
                  <span className="h-1 w-1 rounded-full bg-brand" />
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-7 card-lift">
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-5">
                Custom plans, nutrition guidance and weekly check-ins. One-on-one accountability
        ...
        <div className="mx-auto max-w-6xl px-4 md:px-6 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-6 text-white/60 leading-relaxed">
              Unisex gym above Axis Bank in Hasthinapuram. Serious equipment, coaches who actually
              coach, and a community that shows up early. Open long hours so you can train around
              your life.
            </p>
      ...
      <section id="faq" className="py-24 md:py-32 border-t border-white/10 bg-black/30">
        <div className="mx-auto max-w-3xl px-4 md:px-6">
          <p className="font-mono text-[11px] uppercase tracking-[0.35em] text-brand mb-4 text-center">
            Common questions
          </p>
          ...
          <div className="space-y-4">
            <details className="group rounded-xl border border-white/10 bg-white/[0.03] open:bg-white/[0.05]">
              <summary className="cursor-pointer list-none px-6 py-5 font-medium flex items-center justify-between">
                ...
                <span className="text-brand text-lg group-open:rotate-45 transition-transform">
                  +
                </span>
              </summary>
              <div className="px-6 pb-5 text-white/60 text-sm leading-relaxed">
                No. 35-B, Vijaya Saras Building, 3rd Floor, Rajendra Prasad Road — above Axis Bank
                in Gayathri Nagar, Hasthinapuram. About two minutes from Chromepet railway station.
              </div>
            </details>
            ...
            <details className="group rounded-xl border border-white/10 bg-white/[0.03] open:bg-white/[0.05]">
              ...
              <div className="px-6 pb-5 text-white/60 text-sm leading-relaxed">
                The floor is open to everyone all day. Our head coach also runs dedicated women’s
                strength blocks in the morning and evening. Being women-owned, comfort and safety
                come first.
              </div>
            </details>
            ...
            <details className="group rounded-xl border border-white/10 bg-white/[0.03] open:bg-white/[0.05]">
              ...
              <div className="px-6 pb-5 text-white/60 text-sm leading-relaxed">
                Gym access starts at ₹1,500/month. Personal training with the head coach starts at
                ₹4,000/month. Quarterly and annual packages have good discounts. Call or WhatsApp
                for current offers.
              </div>
            </details>
            ...
            <details className="group rounded-xl border border-white/10 bg-white/[0.03] open:bg-white/[0.05]">
              ...
              <div className="px-6 pb-5 text-white/60 text-sm leading-relaxed">
                Yes. Two-wheeler parking on-site. Car parking available on Rajendra Prasad Road and
                the adjoining lane.
              </div>
            </details>
            ...
            <details className="group rounded-xl border border-white/10 bg-white/[0.03] open:bg-white/[0.05]">
              ...
              <div className="px-6 pb-5 text-white/60 text-sm leading-relaxed">
                Yes. Message us on WhatsApp or call to book a free trial session. No pressure — just
                come train and decide.
              </div>
            </details>
          </div>
        </div>
